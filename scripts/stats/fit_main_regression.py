...
from src.stats import build_panel, fit_main_regression

load_dotenv()

@hydra.main(version_base=None, config_path="../../configs", config_name="fit_main_regression")
def main(cfg: DictConfig) -> None:
    ...
    print(f"\nbeta = {result.beta:.4f} (SE={result.beta_stderr:.4f}, "
          f"p={result.beta_pvalue:.4g}, 95% CI=[{result.beta_ci_low:.4f}, {result.beta_ci_high:.4f}])")
